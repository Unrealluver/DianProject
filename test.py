...
categories = ['alt.atheism',
              ...
              'talk.religion.misc']
# 导入训练数据
train_path = '/media/patrick/Softwares/PyProject/DianProject/source/20newsbydate/20news-bydate-train'
dataset_train = load_files(container_path=train_path, categories=categories)
# 导入评估数据
test_path = '/media/patrick/Softwares/PyProject/DianProject/source/20newsbydate/20news-bydate-test'
